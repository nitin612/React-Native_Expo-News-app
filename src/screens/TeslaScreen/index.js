...
class AppleScreen extends Component {
  ...
  getArticles = () => {
    axios
      .get(
        "https://newsapi.org/v2/everything?q=tesla&from=2025-06-19&sortBy=publishedAt&apiKey=42f96ae7332147268cf9d2507b5681f2"
      )
      .then(response =>
      ...
      <SafeAreaView style={[styles.container, { backgroundColor: colors.background }]}>
        ...
        {isLoading ? (
          ...
          <View style={[styles.header, { backgroundColor: colors.background }]}>
            <View style={styles.headerContent}>
              <View style={styles.headerTextContainer}>
                <Text style={[styles.headerTitle, { color: colors.primary }]}>Tesla News</Text>
