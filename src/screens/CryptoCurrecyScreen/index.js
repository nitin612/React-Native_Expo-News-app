...
class AppleScreen extends Component {
  ...
  getArticles = () => {
    axios
      .get(
        "https://newsapi.org/v2/everything?q=Cryptocurrency&from=2025-06-19&sortBy=popularity&apiKey=42f96ae7332147268cf9d2507b5681f2"
      )
      .then(response =>
      ...
      <SafeAreaView style={[styles.container, { backgroundColor: colors.background }]}>
        ...
        {isLoading ? (
          ...
          <View style={[styles.header, { backgroundColor: colors.background }]}>
            <View style={styles.headerContent}>
              <View style={styles.headerTextContainer}>
                <Text style={[styles.headerTitle, { color: colors.primary }]}>Cryptocurrency News</Text>
